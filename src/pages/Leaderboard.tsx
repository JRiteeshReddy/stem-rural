      ...
      <main className="max-w-4xl mx-auto p-6">
        ...
        <PixelCard variant="orange" className="p-4">
          <div className="space-y-2">
            {!leaderboard ? (
              <div className="text-black" style={{ fontFamily: "'Pixelify Sans', monospace" }}>
                Loading...
              </div>
              ...
              leaderboard.map((s: any, index: number) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-bold text-black" style={{ fontFamily: "'Pixelify Sans', monospace" }}>
                        {s.name}
                      </div>
                      <div className="text-xs text-black/80" style={{ fontFamily: "'Pixelify Sans', monospace" }}>
                        Tests: {s.testsCompleted}
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="font-bold text-black" style={{ fontFamily: "'Pixelify Sans', monospace" }}>
                      {s.credits} 💰
                    </span>
                    <span className="text-xs bg-orange-300 border border-orange-500 px-2 py-0.5 text-black" style={{ fontFamily: "'Pixelify Sans', monospace" }}>
                      {s.badge}
                    </span>
                    {user?.role === "teacher" && (
                      <PixelButton
